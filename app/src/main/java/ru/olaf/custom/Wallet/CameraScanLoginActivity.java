...
@TargetApi(18)
public class CameraScanLoginActivity extends BaseFragment implements Camera.PreviewCallback {

    private TextView titleTextView;
    private TextView descriptionText;
    private CameraView cameraView;
    private HandlerThread backgroundHandlerThread = new HandlerThread("ScanLoginCamera");
        ...
        BottomSheet bottomSheet = new BottomSheet(parentFragment.getParentActivity(), false) {
            {
                ...
                CameraScanLoginActivity fragment = new CameraScanLoginActivity() {
                    @Override
    ...
    public CameraScanLoginActivity() {
        super();
    ...
    public View createView(Context context) {
        ...
        recognizedMrzView.setText(LocaleController.getString("WalletScanCodeLoginNotFound", R.string.WalletScanCodeLoginNotFound));
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public void run() {
                if (cameraView != null && !recognized && cameraView.getCameraSession() != null) {
                    cameraView.getCameraSession().setOneShotPreviewCallback(CameraScanLoginActivity.this);
    ...
    private void showErrorAlert() {
        AlertsCreator.createSimpleAlert(getParentActivity(), LocaleController.getString("WalletQRCode", R.string.WalletQRCode), LocaleController.getString("WalletScanImageLoginNotFound", R.string.WalletScanImageLoginNotFound)).show();
    }
    ...
    private void onNoLoginFound(boolean alert) {
        AndroidUtilities.runOnUIThread(() -> {
            if (alert) {
                showErrorAlert();
                return;
